 ...
 */
public class PostAttendanceService extends Service {

    private String TAG = "EN:PostAttendanceService";
    private PostAttendanceResponseReceiver mPostAttendanceResponseReceiver;
     ...
     */
    public PostAttendanceService() {
        logi(":: PostAttendanceService");
        mPostAttendanceResponseReceiver = new PostAttendanceResponseReceiver(new Handler());
    }
...
*/
     ...
     */
    class PostAttendanceResponseReceiver extends ResultReceiver {

        private String TAG = "EN:PostAttendanceService:PostAttendanceResponseReceiver";
        /**
         ...
         * @param handler
         */
        public PostAttendanceResponseReceiver(Handler handler) {
